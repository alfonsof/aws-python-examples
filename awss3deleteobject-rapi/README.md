# AWS S3 Delete Object Python example

This folder contains a Python application example that handles S3 buckets on AWS (Amazon Web Services).

Delete an object in a S3 bucket using the Resource API (high-level) of Boto 3.
...
* Run the code.
  ...
  * `<OBJECT_NAME>` by Object name.

  Run application:

  ```bash
  python s3deleteobject.py <BUCKET_NAME> <OBJECT_NAME>
  ```
